...
Remember that in the digital age, privacy requires ongoing attention and management. At Sentinela, we help organizations and individuals understand and manage their digital footprints through our comprehensive OSINT services.
    `,
    featuredImage: "/blog/digital-footprint.jpg",
    author: {
      id: "author-1",
      name: "Alex Morgan",
      avatar: "/blog/authors/alex-morgan.jpg",
    },
...
Organizations that develop robust OSINT capabilities—either in-house or through specialized partners like Sentinela—will gain a significant advantage in risk management and strategic decision-making.
...
OSINT has transformed from a niche intelligence-gathering technique to an essential component of corporate due diligence. By leveraging publicly available information through structured methodologies, organizations can make more informed decisions, mitigate risks, and protect their interests in an increasingly complex business environment.
    `,
    featuredImage: "/blog/osint-corporate.jpg",
    author: {
      id: "author-2",
      name: "Sarah Chen",
      avatar: "/blog/authors/sarah-chen.jpg",
    },
    publishedAt: "2023-10-22T14:15:00Z",
...
Remember that security is an ongoing process, not a one-time project. Regular assessment, training, and adaptation are essential to maintaining effective defenses against the ever-evolving landscape of social engineering attacks.
    `,
    featuredImage: "/blog/social-engineering.jpg",
    author: {
      id: "author-3",
      name: "Michael Rodriguez",
      avatar: "/blog/authors/michael-rodriguez.jpg",
    },
    publishedAt: "2023-11-08T09:45:00Z",
...
export async function getBlogPosts(): Promise<BlogPost[]> {
  ...
  // Return sorted by publish date (newest first)
...
export async function createBlogPost(
  ...
  // In a real app, this would create a new post in your database
  // Simulate API delay
  ...
  const newPost: BlogPost = {
    ...
    author: {
      id: authorId,
      name: "Admin User", // In a real app, you would fetch the author's name
    },
...
export async function updateBlogPost(
  ...
  // In a real app, this would update a post in your database
  // Simulate API delay
  await new Promise((resolve) => setTimeout(resolve, 1000))

  // Find the post to update
  const postIndex = BLOG_POSTS.findIndex((post) => post.id === postId)
  ...
  // Update the post
  const updatedPost = {
    ...BLOG_POSTS[postIndex],
    ...postData,
    updatedAt: new Date().toISOString(),
  }

  // If the title changed, update the slug
  if (postData.title && postData.title !== BLOG_POSTS[postIndex].title) {
    updatedPost.slug = postData.title
      .toLowerCase()
      .replace(/[^\w\s]/gi, "")
      .replace(/\s+/g, "-")
  }
  ...
  BLOG_POSTS[postIndex] = updatedPost
...
export async function deleteBlogPost(postId: string): Promise<boolean> {
  // In a real app, this would delete a post from your database
  // Simulate API delay
  ...
  // Get the slug for revalidation
  const slug = BLOG_POSTS[postIndex].slug
